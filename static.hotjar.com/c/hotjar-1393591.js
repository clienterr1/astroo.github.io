window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "features": ["client_script.compression.pc", "settings.billing_v2", "feedback.embeddable_widget", "feedback.widget_telemetry", "error_reporting", "ingestion.events_v2", "client_script.safe_date", "ask.use_insights_internal_api", "survey.image_question", "feedback.widgetV2", "survey.type_button", "ingestion.http.page_content", "heatmap.continuous.manual_retaker", "ask.separate_service"]
};
...
! function(e) {
    ...
    217: function(e, t, r) {
        ...
        window.hj = window.hj || function() {
            ...
            d.async = 1, d.src = hj.scriptDomain + t, d.charset = "utf-8", f.appendChild(d), c.revision = "3542c7655c26", window.hjBootstrap = c
        }, window.hjBootstrap("https://script.hotjar.com/", "modules.bd615e91f206bba6c106.js", "1393591"), window.hjLazyModules = window.hjLazyModules || {
            SURVEY_V2: {
                js: "survey-v2.c689c893b16c30c5115b.js"
            },
            SURVEY_BOOTSTRAPPER: {
                js: "survey-bootstrapper.37dfb2ac952498c1797e.js"
            },
            SURVEY_ISOLATED: {
                js: "survey-isolated.72c3947fe0fbeb0de837.js"
            },
            HEATMAP_RETAKER: {
                js: "heatmap-retaker.aa641f062f2ba8952f8d.js"
            },
            SURVEY_INVITATION: {
                js: "survey-invitation.728a43bf14787c767930.js"
            },
            NOTIFICATION: {
                js: "notification.da0f02128c4ecc72e92e.js"
            },
            INCOMING_FEEDBACK: {
                js: "incoming-feedback.05e947dfba2cfef8c4ee.js"
            },
            PREACT_INCOMING_FEEDBACK: {
                js: "preact-incoming-feedback.95453546ba2632b6d354.js"
            },
            SENTRY: {
